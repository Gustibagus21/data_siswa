	...
	if (isset($_FILES['foto'])) {
		...
		if (move_uploaded_file($foto_temp, $path)) {
			...
			if ($query) {
				...
				echo '<script>alert("Profile berasil di Update");location.href="?page=profil";</script>';
			}
		}
	}
...
if (isset($_POST['password_lama'])) {
	...
	if ($data == 0) {
		...
		if ($query) {
			echo '<script>alert("Password Berhasil Di Ganti"); location.href="?page=profil";</script>';
		}
	}
}
	...
	<div class="col-md-4 col-xl-3">
		<div class="card mb-3">
			<div class="card-header">
				<h5 class="card-title mb-0" align="center"> Foto Profile </h5>
			</div>
			<div class="card-body text-center">
				<img src="foto/<?php echo $_SESSION['user']['photo'] ?>" alt="<?php echo $_SESSION['user']['nama_lengkap']; ?>" class="img-fluid rounded-circle mb-2" width="128" height="128" />
